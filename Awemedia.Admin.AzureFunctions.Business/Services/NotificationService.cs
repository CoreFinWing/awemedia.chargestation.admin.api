...
namespace Awemedia.Admin.AzureFunctions.Business.Services
{
    public class NotificationService : INotificationService
    {
        ...
        public void SendNotification(Models.Notification notification)
        {
            ...
            var httpWebRequest = (HttpWebRequest)WebRequest.Create(Environment.GetEnvironmentVariable("messaging_fcm_web_address"));
            httpWebRequest.ContentType = "application/json";
            httpWebRequest.Headers.Add(string.Format("Authorization: key={0}", Environment.GetEnvironmentVariable("messaging_fcm_server_key")));
            httpWebRequest.Headers.Add(string.Format("Sender: id={0}", Environment.GetEnvironmentVariable("messaging_fcm_sender_id")));
