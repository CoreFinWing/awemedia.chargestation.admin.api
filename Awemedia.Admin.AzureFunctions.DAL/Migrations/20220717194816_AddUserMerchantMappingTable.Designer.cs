...
namespace Awemedia.Admin.AzureFunctions.DAL.Migrations
{
    ...
    [Migration("20220717194816_AddUserMerchantMappingTable")]
    partial class AddUserMerchantMappingTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Awemedia.Admin.AzureFunctions.DAL.DataContracts.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Awemedia.Admin.AzureFunctions.DAL.DataContracts.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Awemedia.Admin.AzureFunctions.DAL.DataContracts.UserMerchantMapping", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Awemedia.Admin.AzureFunctions.DAL.DataContracts.User", b =>
                {
                    ...
                    b.HasOne("Awemedia.Admin.AzureFunctions.DAL.DataContracts.Role", "Role")
                        .WithMany("User")
            ...
            modelBuilder.Entity("Awemedia.Admin.AzureFunctions.DAL.DataContracts.UserMerchantMapping", b =>
                {
                    b.HasOne("Awemedia.Admin.AzureFunctions.DAL.DataContracts.Merchant", "Merchant")
                        .WithMany("MappedMerchant")
                        .HasForeignKey("MerchantId")
                        .HasConstraintName("FK_UserMerchantMapping_Merchant")
                        .IsRequired();

                    b.HasOne("Awemedia.Admin.AzureFunctions.DAL.DataContracts.User", "User")
                        .WithMany("MappedMerchant")
