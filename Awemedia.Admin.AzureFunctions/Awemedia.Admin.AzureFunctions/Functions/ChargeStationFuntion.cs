...
namespace Awemedia.Admin.AzureFunctions.Functions
{
    ...
    public class ChargeStationFuntion
    {
        ...
        public HttpResponseMessage AddChargeStation(
           [HttpTrigger(AuthorizationLevel.Anonymous, "Post", Route = "charge-stations")] HttpRequestMessage httpRequestMessage, [Inject]IChargeStationService _chargeStationServcie, [Inject]IErrorHandler _errorHandler)
        {
